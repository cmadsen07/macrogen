...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButtonMacro.setToolTip(QCoreApplication.translate("MainWindow", u"Ctrl+Shift+N", None))
#endif // QT_CONFIG(tooltip)
        self.pushButtonMacro.setText(QCoreApplication.translate("MainWindow", u"Add macro", None))
#if QT_CONFIG(tooltip)
        self.removeButton.setToolTip(QCoreApplication.translate("MainWindow", u"Ctrl+Shift+Del", None))
#endif // QT_CONFIG(tooltip)
